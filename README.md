...
воспользуйтесь механизмом миграций. Перейдите в "data/storage_dumps/",
при необходимости сменить название базы и доступы поправьте свежесозданный
файл "data/storage_dumpsmigration.default.php" . Далее выполните команду,
находясь в этом каталоге: php migration.php db=mnbv migrate
