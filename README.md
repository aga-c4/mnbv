...
Тестовая загрузка 60000 товаров показала на слабом VDS и ноутбуке время генерации
страницы около 0,03-0,05 секунд. Время генерации шаблона поиска - 0,2-0,5 сек
при достаточно качественном поиске. Это время существенно можно сократить, но 
сейчас это не приоритетная задача.

В течении ближайших 2х недель (до конца июня) мы закачаем демку с большим каталогом
товаров.
