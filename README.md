...
- Автоматическая генерация каталога с параметрами/фильтрами (построение иерархического дерева
...
товаров.
- Время генерации страницы на ноутбуке и слабом VDS около 0,03-0,05 секунд, но в конце процесса
