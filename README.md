...
4. Автозагрузчик фреймворка (в модуле core) поддерживает автозагрузку классов
...
5. Вы можете использовать composer, разместив сcomposer.json в корне проекта
...
6. По-умолчанию для вывода используется метод MNBVf::render(), который позволяет
...
7. Работа с базами данных ведется через систему хранилищ, обслуживаемых 
...
8. CMS позволяет создавать взаимосвязанные информационные структуры на уровне
...
9. Система мультисайтовая, позволяет проводить индивидуальную настройку обработки
различных доменов, привязку их к одной или нескольким информационным структурам,
привязку их к разным шаблонам дизайна.

10. Шаблоны дизайна минималистичные как на примере фронтенда, так и в админке. 
...
11. Система позволяет управлять выводом (html, text, json). Также есть возможность
...
12. Вся маршрутизация ведется в маршрутизаторах системы, на уровне Web сервера идет
...
13. Система задумывалась и реализовывается как мультиязычная, однако полноценная 
...
14. В системе заложено логирование ее работы на всех этапах, в том числе возможность
...
15. Мы планировали использование данной системы при разработке высоконагруженных 
...
16. Возможность работы с системой различными пользователями с различными уровнями
доступа к разным объектам, включая (при необходимости) и приложенные файлы.

17. Распространение системы под максимально открытой лицензией BSD позволяет
использовать ее как основу для коммерческих решений.

18. В системе закладывается функционал работы со служебными скриптами, которые могут
...
11. Зайдите в хранилище сайты, отредактируйте "Демо версия сайта" и по завершению
