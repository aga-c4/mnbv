 ...
 * Time: 00:00
 */
class PglistController extends AbstractMnbvsiteController {
    ...
    public function action_list($item=array(),$tpl_mode='html', $console=false){
        ...
        $item['list'] = MNBVStorage::getObjAcc($storage,
                array("id","parentid","pozid","type","typeval","visible","access","access2","first","name","namelang","about","aboutlang","text","vars","files","siteid","date","date1","date2","alias"),
        ...
        $item['page_sctpl'] = 'tpl_pglist.php'; //По-умолчанию
