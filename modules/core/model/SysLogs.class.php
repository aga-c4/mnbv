...
class SysLogs {
    ...
    /**
     * @var bullean Определяет будет ли вообще накапливаться информация по логу. Не влияет на настройку вывода лога в консоль. Важно для длительно работающих циклических скриптов, где это может сожрать всю память
     */
    public static $logsEnable = true;

    /**
     * @var bullean Определяет будет ли вообще накапливаться информация по ошибкам. Не влияет на настройку вывода лога в консоль. Важно для длительно работающих циклических скриптов, где это может сожрать всю память
     */
    public static $errorsEnable = true;

    /**
     * @var bullean Перед каждой записью выводить дату-время
     */
    public static $logViewTime = false;

    /**
     * @var bullean Перед каждой записью выводить контроллер
     */
    public static $logViewController = false;

    /**
     * @var bullean Видимость Лога работы скрипта
     */
    ...
    /**
     * @var bullean Сохранение Лога работы скрипта
     */
