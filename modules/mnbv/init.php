...
//Lang::addNewLangs(array('ru','eng')); //При необходимости так можно добавить новый язык в списк алиасов языков
...
if (Lang::isDefLang()) MNBVf::requireFile(MNBV_PATH . 'lang/LangDict_'.Glob::$vars['def_lang'].'.php');
