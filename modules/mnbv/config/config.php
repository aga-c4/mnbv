...
Glob::$vars['sizegr_types_levels'] = array( //Максимальный объем в куб.см и макс. измерение в см.
    "1" => array("v"=>200000, "h"=>200, "l"=>200), //0,2 куба не более 1х1х0,2 курьер в руках или машине
    "2" => array("v"=>2000000, "h"=>200, "l"=>200), //2 куба до 2 метров (ларгус)
    "3" => array("v"=>10000000, "h"=>200, "l"=>300), //10 кубов до 3 метров (газель)
    "4" => array("v"=>40000000, "h"=>200, "l"=>600), //40 кубов до 6 метров (газон НЕКСТ)
    "5" => array("v"=>100000000, "h"=>200, "l"=>1200), //Фура 100 кубов и 12 метров
);
...
Glob::$vars['one_sizegr_types_levels'] = array( //Максимальный объем в куб.см и макс. измерение в см.
    "1" => array("v"=>200000, "h"=>200, "l"=>100), //0,2 куба не более 1х1х0,2 курьер в руках или машине
    "2" => array("v"=>2000000, "h"=>100, "l"=>200), //2 куба до 2 метров (ларгус)
    "3" => array("v"=>2000000, "h"=>200, "l"=>300), //2 куба до 3 метров (газель)
    "4" => array("v"=>4000000, "h"=>200, "l"=>600), //4 куба до 6 метров (газон НЕКСТ)
    "5" => array("v"=>100000000, "h"=>200, "l"=>1200), //Фура 100 кубов и 12 метров
);
...
Glob::$vars['prod_qty_limit'] = false; //Ограничение по реальному наличию при формировании заказа
