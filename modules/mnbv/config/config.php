...
Glob::$vars['cacheMode'] = 'rw'; //Режим работы кеша (none/rw/r/w) 
...
"default" => array(//Дефолтовые настройки 0 в одном из измерений - не закачивать или не создавать изображение
    ...
    'img_min_max_w' => 200,         //Максимальная ширина минииконки
    'img_min_max_h' => 200,         //Максимальная высота минииконки
...
Glob::$vars['attr_color_folder_id'] = 12; //Идентификатор папки с цветами товаров в хранилище атрибутов  
