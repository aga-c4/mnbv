...
SysStorage::$storage['urlaliases'] = array( //Архив котировок и т.п.
    ...
    'stru' => array(
        ...
        "type" => array("type"=>"int", "size"=>2, "creatval"=>0, "dbtype"=>"int"), // Идентификатор типа (в конфиге прописаны типы стандартные, можно дополнить)
        "alias" => array("type"=>"string", "size"=>100, "creatval"=>"", "dbtype"=>"varchar"), //Команда роботу
