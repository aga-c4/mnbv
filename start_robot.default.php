...
$startModule = 'zbrobots'; //Запускаемый базовый модуль, если не установлен, то берем из констант и конфига
...
$systemErrorsView = true; //Видимость Ошибок работы скрипта
