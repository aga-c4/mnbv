...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				js: {
					lightbox:	'/src/mnbv/js/jquery.lightbox.min.js',
					colorBlend:	'/src/mnbv/js/jquery.color.min.js'
				},
				css: {
					lightbox:	'/src/mnbv/css/jquery.lightbox.css'
				}
			},
			uncompressed: {
				js: {
					lightbox:	'/src/mnbv/js/jquery.lightbox.js',
					colorBlend:	'/src/mnbv/js/jquery.color.js'
				},
				css: {
					lightbox:	'/src/mnbv/css/jquery.lightbox.css'
				}
			...
			images: {
				prev:		'/src/mnbv/img/lightbox/prev.gif',
				next:		'/src/mnbv/img/lightbox/next.gif',
				blank:		'/src/mnbv/img/lightbox/blank.gif',
				loading:	'/src/mnbv/img/lightbox/loading.gif'
			}
		},
