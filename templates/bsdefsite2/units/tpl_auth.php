...
<div class="row justify-content-md-center">
    <div class="my-5 align-middle col-lg-4 col-md-6 col-sm-8 col-xs-12">
        <form class="" action="" method=post onsubmit="CheckForm();" name=authform>
            ...
            <input class="mt-3 btn btn-lg btn-primary btn-block" type=button onclick="CheckForm();" value="<?=Lang::get("Authorise");?>">
